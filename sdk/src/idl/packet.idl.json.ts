export const PACKET_IDL_JSON ={
  ...
  "instructions": [
    ...
    {
      "name": "room_stage_recipient_page",
      "discriminator": [
        77,
        154,
        223,
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "latest_header_member_version",
            "docs": [
          ...
          {
            "name": "recipient_checkpoint_epoch",
            "docs": [
          ...
          {
            "name": "recipient_assigned_until_slot",
            "docs": [
