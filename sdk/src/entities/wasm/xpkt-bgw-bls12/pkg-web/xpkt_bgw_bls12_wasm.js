 ...
 * @returns {Uint8Array}
 */
export function wasm_aggregate_g1_flat(flat) {
 ...
 * @returns {Uint8Array}
 */
export function wasm_aggregate_g1_signed(add_flat, sub_flat) {
 ...
 * @returns {Uint8Array}
 */
export function wasm_aggregate_g2_flat(flat) {
    const ptr0 = passArray8ToWasm0(flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function wasm_aggregate_g2_signed(add_flat, sub_flat) {
    const ptr0 = passArray8ToWasm0(add_flat, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(sub_flat, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function wasm_decapsulate_epoch_key(args) {
 ...
 * @returns {Uint8Array}
 */
export function wasm_decapsulate_epoch_key_flat(args) {
 ...
 * @returns {any}
 */
export function wasm_derive_admin_secret(seed, capacity) {
 ...
 * @returns {Uint8Array}
 */
export function wasm_derive_room_public_key(admin_secret) {
 ...
 * @returns {any}
 */
export function wasm_encapsulate_epoch_key(args) {
 ...
 * @returns {any}
 */
export function wasm_encapsulate_epoch_key_flat(args) {
 ...
 * @returns {any}
 */
export function wasm_extract_user_secret(admin_secret, slot) {
 ...
 * @returns {any}
 */
export function wasm_extract_user_secret_from_g1_power(admin_secret, slot, p1_slot_g1) {
    const ptr0 = passStringToWasm0(slot, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function wasm_params_root(params) {
 ...
 * @returns {any}
 */
export function wasm_prefix_g1_powers(powers) {
 ...
 * @returns {any}
 */
export function wasm_prefix_g2_powers(powers) {
 ...
 * @returns {any}
 */
export function wasm_setup_public_params(admin_secret) {
 ...
 * @returns {string}
 */
export function xpkt_bgw_backend_status() {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {string}
 */
export function xpkt_bgw_curve_id() {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {string}
 */
export function xpkt_bgw_scheme_id() {
    let deferred1_0;
    let deferred1_1;
    try {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('xpkt_bgw_bls12_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
